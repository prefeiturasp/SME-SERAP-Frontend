  ...
  return (
    <>
      <Grid cols="4 4 4 4" className="text-left">
        <h2 className="font-italic font-weight-bolder d-block mb-5 pb-4 cor-azul card-anos">
          Todos os estudantes tem ireito não só à educação, mas à educação de qualidade
      </h2>
